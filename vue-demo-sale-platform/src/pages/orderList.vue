...
<script>
  import VSelection from '../components/base/selected'
  ...
  export default {
    ...
    methods: {
      productChange (obj) {
        this.$store.commit('updateParams', {   //同步mutations，commit
          key: 'productId',
          val: obj.value
        })
        this.$store.dispatch('fetchOrderList')  //异步actions，dispatch
...
//        this.getList()
    ...
    mounted () {
      this.getList()
      console.log(this.$store.getters.getOrderList)  //获取值 getters
